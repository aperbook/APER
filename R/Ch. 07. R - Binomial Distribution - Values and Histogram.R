...
# The function dbinom(x, n, p) returns the probabilities for all x values of the
...
barplot(dbinom(x,n,p), names.arg=x, 
        xlab="Number of successes, x, in n attempts", ylab="Probability on x successes in n attempts")
