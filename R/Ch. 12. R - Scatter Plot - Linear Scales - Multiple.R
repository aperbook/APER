# R - SCATTER PLOT - LINEAR SCALES - MULTIPLE
...
# The scatter plots:
plot(t, z1, pch=20, xlab="t (s)", ylab="z (m)", xlim=c(0,55), ylim=c(-50, 650), grid(), col="black")
points(t, z2, pch=20, xlab="t (s)", ylab="z (m) (m/s)", xlim=c(0,55), ylim=c(-50, 650), grid(), col="red")
points(t, z3, pch=20, xlab="t (s)", ylab="z (m) (m/s)", xlim=c(0,55), ylim=c(-50, 650), grid(), col="green")
points(t, z4, pch=20, xlab="t (s)", ylab="z (m) (m/s)", xlim=c(0,55), ylim=c(-50, 650), grid(), col="blue")

# Add labels to the three curves:
text(53, 310, "z1", cex=1)
text(53, 410, "z2", cex=1)
text(53, 510, "z3", cex=1)
text(53, 570, "z4", cex=1)
