# R - SCATTER PLOT - LOG-LINEAR SCALES
...
plot(t, z, log="x", pch=20, xlab="t (s)", ylab="z (m)", xlim=c(1,50), ylim=c(-200, 600), grid())
...
curve(3.374-4.355*x+1.054*x^2-0.01774*x^3+3.986e-05*x^4, from=1, to=50, add=T, col="red")
